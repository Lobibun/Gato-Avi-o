...
public class Player : MonoBehaviour
{
    ...
    void UpdateBounds()
    {
        minX = CameraBounds.instance.MinX + playerSpriteSize.x;
        maxX = CameraBounds.instance.MaxX - playerSpriteSize.x;
        minY = CameraBounds.instance.MinY + playerSpriteSize.y;
        maxY = CameraBounds.instance.MaxY - playerSpriteSize.y;
    }
    ...
    public void RefreshMaxHp()
    {
        ...
        float bonus = (StatusManager.instance != null) ? StatusManager.instance.GetHealthBonus() : 0f;

        maxHp = baseMaxHp + bonus;
